...
class MapsContainer extends Component {
  ...
  // With the constraints, find some places serving pills
  handleSearch = (() => {
  ...
  render() {
    ...
    return (
      <div className="w-100 d-flex py-4 flex-wrap justify-content-center">
        <h1 className="w-100 fw-md">Search for Pharmacies</h1>
        {/* Constraints section */}
        ...
        <section className="col-8 h-lg">
          <GoogleMapReact
            bootstrapURLKeys={{
              key: 'AIzaSyA7mYkjfwvu6-__Mi5fjAiC5IjzjDHcgow',
          ...
          <>
            ...
            <section className="col-12">
              <div className="d-flex flex-column justify-content-center">
                <h1 className="mb-4 fw-md">Pharmacies</h1>
